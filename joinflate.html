    ...
    <nav class="pt-10 relative">
      <div class="flex items-center justify-between rounded-[30px] bg-white px-5 py-5">
          ...
          <div class="hidden lg:flex">
              <ul class="flex xl:gap-10 gap-4">
                  <li><a href="#" class="text-[#838383] xl:text-base text-sm font-medium hover:text-[#FFC300]">Browse Listings</a></li>
                  <li><a href="#" class="text-[#838383] xl:text-base text-sm font-medium hover:text-[#FFC300]">Contact Us</a></li>
      ...
      <div id="mobile-menu" class="fixed top-0 left-0 w-full h-full bg-white shadow-lg translate-y-[-100%] transition-transform duration-300">
          ...
          <ul class="text-center space-y-6 mt-10">
              <li><a href="#" class="text-[#838383] text-lg font-medium hover:text-[#FFC300]">Browse Listings</a></li>
              <li><a href="#" class="text-[#838383] text-lg font-medium hover:text-[#FFC300]">Contact Us</a></li>
